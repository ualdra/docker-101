...
A mas inri es interesante comprobar que recursos reserváis para que docker pueda ser utilizado sin que termine colapsando el funcionamiento de vuestro sistema. Los recursos reservados dependeran mucho de vuestro sistema, pero es recomendable que al menos reserveis dos cores y un par de Gb de RAM.
